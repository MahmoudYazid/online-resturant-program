...
export default function OrderComponant() {
    ...
    const SendOrder=async ()=>{
       await fetch(`http://localhost:3000/api/PostOrder?name=${NameState}&address=${AddressState}&tel=${PhoneState}&order=${OrderState}&note=${NoteState}&email=${EmailState}`).then((response)=>{
